...
+ Daten *modellieren* (um Fragen wissenschatlich zu beantworten)
...
- Bedingte Anweisungen (If Statements)
  ...
  - `if (condition) ifelse (condition) {Do something} else {Do something}`
- Schleifen
  - For Loop `for (variable in sequence){Do something}`
  - While Loop `while (condition){Do something}`
- Funktionen `function_name <- function(var){Do something; return(new_variable)}`
